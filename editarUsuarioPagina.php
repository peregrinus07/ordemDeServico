...
*/
     ...
     include_once("conexao.php");
  	 ...
  	 $sql = "SELECT * FROM tabela_usuario where id_usuario='$id'";
 ...
 while ($registro = mysqli_fetch_array($resultado))
   {
       ...
       $numero_endereco = $registro["numero_endereco_usuario"];
   }


$sql ="   select * from tabela_usuario, tabela_endereco_usuario, tabela_descricao_rua,
 ...
 while ($registro = mysqli_fetch_array($resultado))
   {
       ...
       $cep = $registro["cep_endereco_usuario"];
   }
...
<body>
	...
	<div class="row">
      ...
      editarUsuarioMysql.php?id=<?php echo $idCliente; ?>" method="POST">
   
      <legend style="">Usuario </legend>

    <div class="form-group">
    <label for="inputAddress">Nome do Usuario:</label>
